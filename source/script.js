...
function updateStatus() {
  ...
  if (!responseText) {  updateStatusField("The call metadata is undefined");
  ...
  let requestUrl = rootUrl + callJSON.uri;
...
function dial() {
  ...
  let Twiml = '<Response><Dial record="' + (record === 0 ? "do-not-record" : "record-from-ringing-dual") + '" answerOnBridge="true" callerId="' + twilioNumber + '">' + toNumber + "</Dial></Response>";
